...
public class BetaOverworldBiomeSource extends BiomeSource {
    ...
    protected BetaOverworldBiomeSource(Registry<Biome> biomeRegistry) {
        this(
                biomeRegistry.getOrCreateEntry(Spacepunk.BETA_RAINFOREST),
                biomeRegistry.getOrCreateEntry(Spacepunk.BETA_SWAMPLAND),
                biomeRegistry.getOrCreateEntry(Spacepunk.BETA_SEASONAL_FOREST),
                biomeRegistry.getOrCreateEntry(Spacepunk.BETA_FOREST),
                biomeRegistry.getOrCreateEntry(Spacepunk.BETA_SAVANNA),
                biomeRegistry.getOrCreateEntry(Spacepunk.BETA_SHRUBLAND),
                biomeRegistry.getOrCreateEntry(Spacepunk.BETA_TAIGA),
                biomeRegistry.getOrCreateEntry(Spacepunk.BETA_DESERT),
                biomeRegistry.getOrCreateEntry(Spacepunk.BETA_PLAINS),
                biomeRegistry.getOrCreateEntry(Spacepunk.BETA_ICE_DESERT),
                biomeRegistry.getOrCreateEntry(Spacepunk.BETA_TUNDRA),
                biomeRegistry.getOrCreateEntry(Spacepunk.BETA_HELL),
                biomeRegistry.getOrCreateEntry(Spacepunk.BETA_SKY)
        );
    }
