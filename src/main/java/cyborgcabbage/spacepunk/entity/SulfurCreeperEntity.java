...
import cyborgcabbage.spacepunk.entity.ai.goal.SulfurCreeperIgniteGoal;
...
public class SulfurCreeperEntity extends HostileEntity {
    private static final TrackedData<Integer> FUSE_SPEED = DataTracker.registerData(SulfurCreeperEntity.class, TrackedDataHandlerRegistry.INTEGER);
    private static final TrackedData<Boolean> CHARGED = DataTracker.registerData(SulfurCreeperEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private static final TrackedData<Boolean> IGNITED = DataTracker.registerData(SulfurCreeperEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    public SulfurCreeperEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new SulfurCreeperIgniteGoal(this));
    ...
    public static DefaultAttributeContainer.Builder createSulfurCreeperAttributes() {
    ...
    protected void dropEquipment(DamageSource source, int lootingMultiplier, boolean allowDrops) {
        SulfurCreeperEntity creeperEntity;
        super.dropEquipment(source, lootingMultiplier, allowDrops);
        Entity entity = source.getAttacker();
        if (entity != this && entity instanceof SulfurCreeperEntity && (creeperEntity = (SulfurCreeperEntity)entity).shouldDropHead()) {
