                ...
                if(world.getBlockState(d3).isOf(Blocks.BLAST_FURNACE)){
                    if(world.isClient){
                        ...
                        if (rocketEntity != null) {
                            ...
                            world.playSound(null, d2, SoundEvents.BLOCK_ANVIL_USE, SoundCategory.BLOCKS, 1f, 1);
                            if (placer instanceof ServerPlayerEntity s)
                                Spacepunk.BUILD_ROCKET.trigger(s);
                        } else {
